...
from TimeSeriesTransformer.PositionalEncoder import  PositionalEncoder
...
class model_parameters:
    ...
    input_size = 9 # The number of input variables. 1 if univariate forecasting.
...
class TimeSeriesTransformer(nn.Module):
    ...
    Unlike the paper, and the Transformer that I built from scratch, this class assumes that: 
    -- input layers, positional encoding layers and linear mapping layers are separate from the encoder and decoder, 
    ...
    def __init__(self,
        ...
        # in this case, because nn.TransformerEncoderLayer per default normalizes
    ...
    def forward(self, src:Tensor, tgt:Tensor, src_mask:Tensor = None, tgt_mask:Tensor = None) -> Tensor:
        ...
        Args:
            ...
            tgt_mask: the mask for the tgt sequence to prevent the model from
                      using data points from the target sequence
        """
        src = self.encoder_input_layer(src) # src shape: [batch_size, src length, dim_val] 
