...
class HeadAttention(nn.Module):
    '''
    Each HeadAttention is a scaled dot product attention of query, key and value
    '''
    ...
    def forward(self, query: Tensor, key: Tensor, value: Tensor) -> Tensor:
        return self.scaled_dot_product_attention(self.q(query), self.k(key), self.v(value))
